...
This module provides a list of public Mussels recipe cookbooks.
To have your cookbook added to the list, create an issue here:

    https://github.com/Cisco-Talos/Mussels/issues
